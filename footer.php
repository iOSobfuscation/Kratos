						...
						<div class="container">
							<div class="row">
								<div class="col-md-6 col-md-offset-3 footer-list text-center">
									...
									<p>Copyright <?php echo date('Y'); ?> <a href="<?php echo get_option('home'); ?>"><?php bloginfo('name'); ?></a>. All Rights Reserved.<br>Theme <a href="https://github.com/zhouzhipeng/Kratos" target="_blank" rel="nofollow">Kratos</a> made by <a href="https://zhouzhipeng.com" target="_blank" rel="nofollow">zhouzhipeng</a>
